        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-display font-extrabold text-white mb-8 tracking-tighter">
              Le <span className="text-white/40 italic">Bubble</span> Tag™
            </h1>
            <p className="max-w-3xl mx-auto text-white/60 text-lg md:text-xl font-light leading-relaxed">
              Une signature biologique tridimensionnelle unique au monde, générée par le chaos et impossible à répliquer.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="flex flex-col lg:flex-row items-center gap-24">
            <div className="lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-5xl font-display font-extrabold text-navy-deep mb-8 leading-tight">
                La science de <br />l'authentification
              </h2>
              <p className="text-slate-500 text-lg mb-10 leading-relaxed font-light">
                Le Bubble Tag™ repose sur la génération aléatoire de bulles au sein d'un polymère. Ce processus chaotique crée une configuration unique dont les positions et les formes constituent une empreinte infalsifiable.
              </p>
              <div className="space-y-6">
                {[
                  "Identifiant tridimensionnel natif",
                  "Impossible à dupliquer, même par le fabricant",
                  "Vérification instantanée via smartphone",
                  "Durabilité garantie face aux conditions extrêmes"
                ].map((item, i) => (
            ...
            <div className="lg:w-1/2">
              <div className="relative p-12 bg-soft-gray rounded-[3rem] border border-slate-100 shadow-inner">
                ...
                <div className="absolute -bottom-10 -right-10 bg-navy-deep p-8 rounded-[2rem] shadow-2xl border border-white/10 max-w-[240px]">
                  ...
                  <p className="text-white text-sm leading-relaxed font-light mb-4">Empreinte 3D validée par le réseau Prooftag.</p>
      ...
      <section className="section-padding bg-soft-gray">
        <div className="container-custom">
           <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-slate-500 font-light leading-relaxed">Pourquoi le Bubble Tag™ est le choix des administrations souveraines.</p>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <TechBenefitCard 
                icon={Layers}
                title="Multi-Couches"
                desc="Combine sécurité physique, sécurité numérique et identité biométrique du support."
              />
              <TechBenefitCard 
                icon={ShieldCheck}
                title="Inviolable"
                desc="La structure étant volumétrique, elle ne peut être copiée par aucun scanner à plat."
              />
              <TechBenefitCard 
                icon={Zap}
                title="Preuve Directe"
                desc="Permet à l'usager de vérifier lui-même l'authenticité de sa vignette sans outil complexe."
              />
           </div>
        </div>
      </section>
