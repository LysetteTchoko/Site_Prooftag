              ...
              >
                <div className="flex flex-col h-full">
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <span className="text-3xl font-display font-black text-primary/10 group-hover:text-primary/20 transition-colors">
          ...
          <div className="bg-primary rounded-[3rem] p-12 md:p-24 text-white text-center relative overflow-hidden">
             <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <div className="flex justify-center">
                  <a href="https://portail.prooftagcatis.com" className="btn-primary !bg-white !text-primary !rounded-2xl shadow-2xl">
