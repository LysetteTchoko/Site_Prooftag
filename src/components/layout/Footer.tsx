    ...
    <footer id="contact" className="bg-navy-deep pt-24 pb-12 text-white border-t border-white/5">
      <div className="container-custom">
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-white/20 text-[10px] font-bold uppercase tracking-widest md:w-auto text-center md:text-left">
            &copy; {new Date().getFullYear()} PROOFTAG-CATIS SA. Tous droits réservés.
          </p>
          <div className="flex gap-8 justify-center md:justify-end">
            <Link href="/mentions-legales" className="text-white/20 hover:text-white transition-colors text-[10px] font-bold uppercase tracking-widest">Mentions Légales</Link>
            <Link href="/politique-de-confidentialite" className="text-white/20 hover:text-white transition-colors text-[10px] font-bold uppercase tracking-widest">Confidentialité</Link>
          </div>
        </div>
      </div>
    </footer>
